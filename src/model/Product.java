...
public class Product {
	...
	public String readproducts()
	 ...
	 String productDesc = rs.getString("productDes");
	 ...
	 + "<td><form method='post' action='items.jsp'>"+ "<input name='btnRemove' type='submit' value='Remove'class='btn btn-danger'>"+ "<input name='itemID' type='hidden' value='" + productID+ "'>" + "</form></td></tr>";
	 }
	 con.close();
